...
<html>
    ...
    <body><div class="filter_content"><div  id="contentform">
                <?= form_open('index.php/initiative/insert'); ?>
                <div id="v_spacer"></div>
                <div id="colmain_div">
...
BHU
  ...
  <tr>
                                <td><input type="hidden" name="BHU" size="30">
         ...
         <tr><td>Initiative Name </td></tr>
                            <tr>
                                <td><input type="text" name="initiative_name" size="30">
                                    ...
                                    if ($queryregions->num_rows() > 0)
                                    {
                                        foreach ($queryregions->result() as $row) 
                                        {
											if($row->id == 1)
												...
												$selected = '';
                                            echo '<option value="' . $row->id  . set_select('originator_region[]', $row->id) .'"'. $selected . '>' . $row->name . '</option> ';
                                        }
                                    }
                                    echo '</select>';
                                    ?>
...
<?= $emptyrow ?>
  ...
  <table width=100%>
                            ...
                            <tr>
                                <td><input id='course' type="text" name="executive_sponsor" value="<?php echo set_value('executive_sponsor'); ?>" size="30">
...
<?= $emptyrow ?>
                            ...
                            <tr>
                                <td><input type="text" name="author" value="<?php echo set_value('author'); echo $username; ?>" size="30">
...
<?= $emptyrow ?>
                            ...
                            <tr>
                                <td><input id='course' type="text" name="BPR_contact" value="<?php echo set_value('BPR_contact'); ?>" size="30">
...
<tr><td>Resourcing</td></tr>
 <tr><td width=20%><div style='float:left;font-size:11px'>BPR PM &nbsp;</div> <div id='h_spacer'></div><div id='h_spacer'></div>
	...
	<div style='float:left;font-size:11px'>
 			...
 			<select name='BPR_analyst' style="width:12mm;font-size:smaller">
 				...
 				<option value=2>2</option>
                            ...
                            <tr>
                                <td>Rollover
                                    <br><input  type="radio" name="rollover" value="1" > &nbsp;  <font style="font-size:11px">Yes</font>
                                    <br><input type="radio" name="rollover" value="0" checked> &nbsp; <font style="font-size:11px">No</font  </td><td></td></tr>
<?= $emptyrow ?>
                <tr>
                                <td>Ultimate Gold Impact
                                    <br><input  type="radio" name="ultimate_gold_impact" value="Yes" > &nbsp;  <font style="font-size:11px">Yes</font>
                                    <br><input type="radio" name="ultimate_gold_impact" value="No" checked> &nbsp; <font style="font-size:11px">No</font  </td><td></td></tr>
<?= $emptyrow ?>
                <tr>
                                <td>Type
                                        ...
                                        foreach ($type->result() as $row) 
                                   {
                                   	if($row->id == 1)
												...
												$selected = '';
                                   		echo '<br><input  type="radio" name="type" value="' . $row->id .'" '. $selected .' > &nbsp; <font style="font-size:11px">' . $row->name . '</font>';
                                  }
                                  }?>
                                    </td><td></td></tr>
<?= $emptyrow ?>
                                        ...
                                        {	if(in_array($row->year, $fiscal_yrs_system))
                                        	{
                                            	...
                                            	echo '<option value="' . $row->id  . set_select('start_date_year', $row->id) .'" >' . $row->year . '</option> ';
                                            }
                                        }
                                    }
                                    echo '</select>';
...
<?php echo form_error('track[]'); ?>
                           ...
                           <div id="h_spacer"></div>
                                <div id="col5_div">
                                    Subtrack<br>
                                    <select name="subtrack[]" class="subtrack" size="10" style="width:40mm" >
                                        <option value="All" selected="selected">All</option>
                                                                <?php
...
?>
                            ...
                            <div id="colmain_div">
                                ...
                                <div id="col_div_noborder">
                                    ...
                                    <textarea name="exec_summary"rows="5" cols="50"></textarea>
                                    <div id="error_exec_summary"></div>
<?php echo form_error('exec_summary'); ?>

                                    <br>
                                    Project Description & Scope<br>
                                    <textarea name="proj_description"rows="14" cols="50"></textarea>
...
<?php
                                    ...
                                    if ($queryjustifications->num_rows() > 0)
                                        foreach ($queryjustifications->result() as $row) {
                                            ...
                                            echo '<td><input type="checkbox"  class=justification name="justification[]" value="' . $row->id . '"></td> <td height=17><font style="font-size:11px">' . $row->statement . '</font></td>';
...
<?php
                                    ...
                                    if ($queryregions->num_rows() > 0)
                                        foreach ($queryregions->result() as $row) {
                                            ...
                                            echo '<td width=140 height=28>' . '<input type="checkbox" class="region" name="region[]" value="' . $row->id . '" />&nbsp;&nbsp;<font style="font-size:11px">' . $row->name . '</font></input> ' . '</td> ';
                                            if ($i % 2 == 1) {
                                                echo "</tr>";
                                            }
                                            $i++;
...
<?php echo form_error('region[]'); ?>
                                ...
                                <textarea name="regions_benefitting_justification"rows="5" cols="50"></textarea>
...
var findchildren2 = "<?php echo site_url('index.php/ajaxselect/findchildren2');?>";
var findchildren3 = "<?php echo site_url('index.php/ajaxselect/findchildren3');?>";
var findchildren4 = "<?php echo site_url('index.php/ajaxselect/findchildren4');?>";
                    ...
                    $(document).ready(function(){
                        ...
                        var endmonth = Number($('select[name=end_date_month]').val()); 
                           ...
                           if(startyr == startfirstoption) {
                          		...
                          		if(startmonth < 8){
									alert("The StartDate cannot be before the current fiscal year's first month");	
									flag =1;
                            	}
                            }
                              if(endyr == endfirstoption) {
                          		...
                          		if(endmonth< 8){
									alert("The EndDate cannot be before the current fiscal year's first month");	
									flag =1;
                            	}
                            }
