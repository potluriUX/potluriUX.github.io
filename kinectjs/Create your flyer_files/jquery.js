...
$.widget('oal.fontSelector', {
  ...
  _create: function() {
   ...
   // console.log("<link rel='stylesheet' type='text/css' href='http://fonts.googleapis.com/css?family=" + font + ":400,700,400italic,700italic'></link>");
  ...
  _toggleOpen: function() {
    ...
    if (this.list.is(':visible')) {
      ...
      return $('div.fontSelector ul.fonts li').click(function(e) {
		// ligne rajoutée pour fermer le select une fois la police sélectionnée
